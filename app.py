...
app = FastAPI(title="Zaahir's Tutor")
...
async def get_subjects():
    return {"subjects": ["Mathematics", "Physical Sciences", "Life Sciences"]}
...
@app.post("/chat")
async def chat():
    return {"answer": "Hello! This is Zaahir's Tutor. I'm currently being set up. Full features coming soon!"}
